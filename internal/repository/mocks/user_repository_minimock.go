...
//go:generate minimock -i github.com/sborsh1kmusora/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, in *model.CreateInput) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, in *model.CreateInput)
	...
	funcUpdate          func(ctx context.Context, in *model.UpdateInput) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, in *model.UpdateInput)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, in *model.CreateInput) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, in}
...
// ExpectInParam2 sets up expected param in for UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) ExpectInParam2(in *model.CreateInput) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, in *model.CreateInput)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, in *model.CreateInput) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, in *model.CreateInput) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserRepositoryMockCreateParams{ctx, in},
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, in *model.CreateInput) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, in}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, in}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter in, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v", ctx, in)
	return
}
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, in *model.UpdateInput) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, in}
...
// ExpectInParam2 sets up expected param in for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInParam2(in *model.UpdateInput) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, in *model.UpdateInput)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, in *model.UpdateInput) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, in *model.UpdateInput) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserRepositoryMockUpdateParams{ctx, in},
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, in *model.UpdateInput) (err error) {
	...
	mm_params := UserRepositoryMockUpdateParams{ctx, in}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, in}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.in != nil && !minimock.Equal(*mm_want_ptrs.in, mm_got.in) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter in, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v", ctx, in)
	return
}
