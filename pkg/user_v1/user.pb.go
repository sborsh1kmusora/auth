...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\auser_v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17validate/validate.proto\"?\n" +
	"\rCreateRequest\x12.\n" +
	...
	"\busername\x18\x02 \x01(\tB\t\xfaB\x06r\x04\x10\x04\x18 H\x00R\busername\x88\x01\x01\x12*\n" +
	"\bpassword\x18\x03 \x01(\tB\t\xfaB\x06r\x04\x10\b\x18 H\x01R\bpassword\x88\x01\x01B\v\n" +
	"\t_usernameB\v\n" +
	"\t_password\"\x1f\n" +
	"\rDeleteRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"\x87\x01\n" +
	"\bUserInfo\x12%\n" +
	"\busername\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x04\x18 R\busername\x12%\n" +
	"\bpassword\x18\x02 \x01(\tB\t\xfaB\x06r\x04\x10\b\x18 R\bpassword\x12-\n" +
	"\x04role\x18\x03 \x01(\x0e2\r.user_v1.RoleB\n" +
	"\xfaB\a\x82\x01\x04\x18\x00\x18\x01R\x04role\"\xbc\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12.\n" +
